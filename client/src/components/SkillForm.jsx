  ...
  return (
    <div className='space-y-4'>
      <div className=""> 
        ...
        <p className='text-sm text-gray-500'>Add yor technical and soft skills</p>
      </div>
      <div className="flex gap-2">
        <input type="text" placeholder='Enter a Skill (e.g., JavaScript Mangement)' 
        className='flex px-3 py-2 w-full text-sm' onChange={(e)=> setNewSkill(e.target.value)}
        value={newSkill} onKeyDown={hendleKeyPress}/>
      ...
      {data.length > 0 ? (
        <div className="flex flex-wrap gap-2">
            {
                data.map((skill, index) => (
                    <span className='flex items-center
                     cursor-pointer gap-1 px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm'>
                        {skill}
        ...
        <div className="text-center py-6 text-gray-500">
            ...
            <p className=''>No Skill added yet.</p>
