...
const Action = () => {
  return (
    <div id='cta' className='pt-20 mt-10 mb-10 pb-20'>
       <div className='border-y border-dashed border-slate-200  w-full max-w-6xl mx-auto px-10 sm:px-16'>
            <div className="flex flex-col md:flex-row text-center md:text-left items-center justify-between gap-8 px-3 md:px-10 border-x border-dashed border-slate-200 py-16 sm:py-20 -mt-10 -mb-10 w-full">
                <p className="text-2xl font-medium max-w-2xl text-slate-800">Build a Professional Resume That Helps You <br /> Stand Out and Get Hired</p>
