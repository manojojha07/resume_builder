...
const Testmonials = () => {
  ...
  <div className="max-w-5xl py-10 md:w-full mx-2  md:mx-auto flex flex-col items-center justify-center text-center  p-10 text-black">
   <div className='flex text-center bg-green-200 font-semibold px-5 text-green-500 rounded-lg justify-center items-center'>
    ...
    <p className="px-6 py-2 rounded-full text-sm  ">
        ...
        <h1 className="text-3xl font-semibold text-gray-600 text-center mx-auto">Don't just take our words</h1>
<p className="text-md text-slate-500 mb-7 text-center mt-2 max-w-2xl mx-auto">
Hear what our users say about us. We're always looking for ways to improve. If you have a positive experience with us, leave a review.
            ...
            <div className="marquee-row pb-8 w-full mx-auto max-w-5xl overflow-hidden relative">
                <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-r from-white to-transparent"></div>
